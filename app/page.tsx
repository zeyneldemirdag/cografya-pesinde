...
const METALLIC_MINE_FEATURES: Feature[] = [
  ...
  f("mansurlu-mine", "Feke-Mansurlu · Demir", 50, 50, 7, 6, "mine"),
  ...
  f("payas-mine", "Payas · Boksit", 50, 50, 7, 6, "mine"),
  f("tavas-mine", "Tavas · Manganez", 50, 50, 7, 6, "mine"),
  f("balya-mine", "Balya · Kurşun-Çinko", 50, 50, 7, 6, "mine"),
  f("yenice-lead-zinc", "Yenice · Kurşun-Çinko", 50, 50, 7, 6, "mine"),
  f("keban-lead-zinc", "Keban · Kurşun-Çinko", 50, 50, 7, 6, "mine"),
  f("bolkar-lead-zinc", "Bolkar Dağları · Kurşun-Çinko", 50, 50, 7, 6, "mine"),
  f("zamanti-lead-zinc", "Zamantı · Kurşun-Çinko", 50, 50, 7, 6, "mine"),
  f("akdagmadeni-lead-zinc", "Akdağmadeni · Kurşun-Çinko", 50, 50, 7, 6, "mine"),
...
const INDUSTRIAL_MINERAL_FEATURES: Feature[] = [
  ...
  f("kestelek-boron", "Kestelek · Bor", 50, 50, 7, 6, "mine"),
  ...
  f("cankiri-salt", "Çankırı · Tuz", 50, 50, 7, 6, "mine"),
  f("gulsehir-salt", "Gülşehir · Tuz", 50, 50, 7, 6, "mine"),
...
const ENERGY_RAW_MATERIAL_FEATURES: Feature[] = [
  f("zonguldak", "Ereğli-Zonguldak-Amasra · Taş Kömürü", 31, 20, 9, 6, "mine"),
  ...
  f("tavsanli-lignite", "Tavşanlı · Linyit", 50, 50, 7, 6, "mine"),
  f("can-lignite", "Çan · Linyit", 50, 50, 7, 6, "mine"),
  f("yatagan-lignite", "Yatağan · Linyit", 50, 50, 7, 6, "mine"),
  f("celtek-lignite", "Çeltek · Linyit", 50, 50, 7, 6, "mine"),
  f("nallihan-lignite", "Nallıhan · Linyit", 50, 50, 7, 6, "mine"),
  f("cayirhan-lignite", "Çayırhan · Linyit", 50, 50, 7, 6, "mine"),
  f("dodurga-lignite", "Dodurga · Linyit", 50, 50, 7, 6, "mine"),
  f("askale-lignite", "Aşkale · Linyit", 50, 50, 7, 6, "mine"),
];
...
const SOURCE_BY_QUIZ: Record<string, SourceRef> = {
  ...
  regions: {
    label: "HGM · 1941 Türk Coğrafya Kongresi bölge haritası",
    url: "https://www.harita.gov.tr/uploads/files/downloadabledocuments/cumhuriyetin-ilk-yillarinda-turk-basininda-harita-genel-mudurlugu-1800.pdf",
  },
  climate: {
...
const DISTRIBUTION_POLYGONS: Record<string, Coordinate[][]> = {
  ...
  marmara: [[
    [25.45, 42.35], [31.05, 42.35], [31.2, 40.5],
    [30.5, 40.2], [30.0, 40.0], [29.4, 40.1], [28.8, 39.95],
    [28.2, 39.75], [27.6, 39.65], [27.0, 39.5], [26.4, 39.45],
    [25.45, 39.4],
  ]],
  aegean: [[
    [25.45, 39.4], [26.4, 39.45], [27.0, 39.5], [27.6, 39.65],
    [28.2, 39.75], [28.8, 39.95], [29.4, 40.1], [30.0, 40.0],
    [30.5, 40.2], [31.2, 40.5], [30.7, 40.1], [30.4, 39.7],
    [30.0, 39.2], [30.2, 38.8], [29.8, 38.4], [30.0, 37.8],
    [29.4, 37.45], [28.9, 37.2], [28.4, 37.0], [27.9, 36.8],
    [27.3, 36.6], [26.6, 36.6], [25.45, 36.45],
  ]],
  med: [[
    [25.45, 35.45], [36.0, 35.45], [36.5, 36.2], [36.6, 36.8],
    [37.0, 37.8], [36.5, 38.0], [35.8, 38.0], [34.9, 37.7],
    [34.0, 37.5], [33.0, 37.3], [32.0, 37.4], [31.0, 37.5],
    [30.0, 37.7], [29.4, 37.45], [28.9, 37.2], [28.4, 37.0],
    [27.9, 36.8], [27.3, 36.6], [26.6, 36.6], [25.45, 36.45],
  ]],
  black: [[
    [29.0, 42.35], [42.25, 42.35], [42.2, 41.4], [41.8, 40.9],
    [41.0, 40.2], [40.0, 39.8], [39.5, 39.8], [39.0, 39.75],
    [38.0, 39.85], [37.0, 39.9], [36.0, 40.15], [35.0, 39.95],
    [34.0, 40.35], [33.0, 40.4], [32.0, 40.5], [31.2, 40.5],
    [30.7, 40.9], [30.5, 41.3],
  ]],
  central: [[
    [31.2, 40.5], [32.0, 40.5], [33.0, 40.4], [34.0, 40.35],
    [35.0, 39.95], [36.0, 40.15], [37.0, 39.9], [38.0, 39.85],
    [39.0, 39.75], [39.5, 39.8], [38.6, 39.45], [38.0, 39.2],
    [37.2, 39.0], [36.5, 38.7], [35.7, 38.4], [34.9, 37.7],
    [34.0, 37.5], [33.0, 37.3], [32.0, 37.4], [31.0, 37.5],
    [30.0, 37.7], [29.4, 37.45], [30.0, 37.8], [29.8, 38.4],
    [30.2, 38.8], [30.0, 39.2], [30.4, 39.7], [30.7, 40.1],
  ]],
  east: [[
    [39.5, 39.8], [40.0, 39.8], [41.0, 40.2], [41.8, 40.9],
    [42.2, 41.4], [42.25, 42.35], [44.95, 42.35], [44.95, 37.7],
    [44.0, 37.85], [43.0, 38.3], [42.0, 38.5], [41.0, 38.7],
    [40.0, 38.4], [39.0, 38.3], [38.0, 38.1], [37.0, 37.8],
    [36.5, 38.0], [35.8, 38.0], [34.9, 37.7], [35.7, 38.4],
    [36.5, 38.7], [37.2, 39.0], [38.0, 39.2], [38.6, 39.45],
  ]],
  southeast: [[
    [37.0, 37.8], [38.0, 38.1], [39.0, 38.3], [40.0, 38.4],
    [41.0, 38.7], [42.0, 38.5], [43.0, 38.3], [44.0, 37.85],
    [44.95, 37.7], [44.95, 35.45], [36.0, 35.45], [36.5, 36.2],
    [36.6, 36.8],
  ]],
...
const POINT_COORDINATES: Record<string, Coordinate> = {
  ...
  "avnik-mine": [40.32, 38.95],
  "mansurlu-mine": [35.82, 37.85],
  "kesikkopru-iron": [33.48, 39.53],
  "kokaksu-mine": [31.79, 41.35],
  "payas-mine": [36.22, 36.76],
  "tavas-mine": [29.07, 37.57],
  "balya-mine": [27.58, 39.75],
  "yenice-lead-zinc": [27.25, 39.93],
  "keban-lead-zinc": [38.73, 38.8],
  "bolkar-lead-zinc": [34.62, 37.42],
  "zamanti-lead-zinc": [35.82, 38.08],
  "akdagmadeni-lead-zinc": [35.88, 39.66],
  "kestelek-boron": [28.48, 39.91],
  "adiyaman-phosphate": [38.28, 37.76],
  "bingol-phosphate": [40.5, 38.88],
  "sanliurfa-phosphate": [38.8, 37.17],
  "bitlis-phosphate": [42.1, 38.4],
  "cankiri-salt": [33.62, 40.6],
  "gulsehir-salt": [34.62, 38.75],
  ...
  "tuncbilek-lignite": [29.58, 39.65],
  "tavsanli-lignite": [29.49, 39.54],
  "can-lignite": [27.05, 40.03],
  "yatagan-lignite": [28.14, 37.34],
  "celtek-lignite": [35.65, 40.83],
  "nallihan-lignite": [31.35, 40.19],
  "cayirhan-lignite": [31.68, 40.09],
  "dodurga-lignite": [34.81, 40.85],
  "askale-lignite": [40.69, 39.92],
  cesme: [26.3, 38.32],
  ...
  "seyitomer-energy": [29.576, 39.487],
  "tuncbilek-energy": [29.58, 39.655],
  "yatagan-energy": [28.139, 37.342],
  "hamitabat-energy": [27.037, 41.133],
  "ambarli-energy": [28.676, 40.966],
  "ovaakca-energy": [29.054, 40.283],
