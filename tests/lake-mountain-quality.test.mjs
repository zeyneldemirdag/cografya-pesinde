...
test("genel dağ oyununda Toros, Allahuekber ve Palandöken eksiksizdir", () => {
  ...
  assert.match(generalMountains, /f\("palandoken-d", "Palandöken Dağları"/);
  assert.match(page, /"palandoken-d": \[41\.2753321, 39\.8597575\]/);
  assert.match(
    page,
